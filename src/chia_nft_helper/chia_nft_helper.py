...
if __name__ == "__main__":
    ...
    # Create an instance of ChiaNFTHelper class
    chia_nft_helper = ChiaNFTHelper(args.collection_id, args.did_required)

    # Run the API data extraction and save the results to an Excel file
    chia_nft_helper.run(args.output_file, args.unique)
